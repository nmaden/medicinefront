        ...
        <header class="header">
                ...
                <div class="header__inner">
                    ...
                    <div class="header__white">
                        ...
                        <div class="header__labels" id="header__labels">
                            ...
                            <div class="header__menu">
                                ...
                                <a    @click="changeMenu(1)" id="index_1">Sushi</a>
                                <a    @click="changeMenu(2)" id="index_2">Pizza</a>
                            </div>
                        </div>
                    ...
                    <div class="header__red">
                        ...
                        <div class="header__basket" id="header__basket">
                            ...
                            <p>{{ count }}</p>
                            <button @click="$router.push('/busket')">Order Online</button> 
            ...
            addOrder(index) {
                ...
                if(this.all_data.length>=1) {
                    ...
                    if(exist[0]==true) {
                        ...
                        this.all_data[pivot].counter = this.all_data[pivot].counter +1;
             ...
             for (let index = 0; index < this.all_data.length; index++) {
                ...
                console.log("kosindisi:"+sum_of_data);
            }
