    ...
    export default {
        ...
        mounted() {
            ...
            window.onscroll = function() {
                ...
                if (window.pageYOffset > ride_side.offsetTop+100) {
                
                    ride_side.classList.add("sticky");
                    left_side.classList.add("sticky")
                }
                else {
                    ride_side.classList.remove("sticky");
        ...
        methods: {
            ...
            addOrder(index) {
                ...
                localStorage.setItem("counter",JSON.stringify(this.all_data[pivot].counter));
